...
class AttachmentsController extends AppController
{
    ...
    {
        $attachment = $this->Attachments->get($id, contain: ['Complaints']);
    ...
    public function add()
    {
        ...
        $complaints = $this->Attachments->Complaints->find('list', limit: 200)->all();
        $this->set(compact('attachment', 'complaints'));
    }
